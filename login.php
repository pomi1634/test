...
<link rel="stylesheet" type="text/css" href="./css2/bootstrap.css" media="screen, projection">
...
<div class="gwlogo clearfix">
  ...
  <div class="field field-name-field-logo field-type-image field-label-hidden"><div class="field-items"><div class="field-item even"><img typeof="foaf:Image" src="images/LOGO.png" width="932" height="132" alt="Canada MI University" title="Canada MI University" /></div></div></div>
 </div>
...
<center><u><h2>Admin login page</h2></u></center>

<hr color="#006699">
<br>
<form method="post" action="verify.php">
 <center> Admin Name :<input type="text" name="txtusername" id="txtusername" />
<br>
Password &nbsp&nbsp&nbsp :<input type="password" name="txtpassword" id="txtpassword" /></center>
<br>

      <center><input class="btn btn-success" type="submit" name="submit" value="Login">     </center><br>
     <center><span class="required"><?php if(isset($_GET['error']) && $_GET['error']==1) {echo "Invalid User name/password,Please try again......";}?>
  <?php if(isset($_GET['error']) && $_GET['error']==2) {echo "Please first login to Admin area......";}?></span></center>
      </div>
</form><!-- end slide container --> 
